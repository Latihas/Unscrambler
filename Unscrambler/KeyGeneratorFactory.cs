...
public abstract class KeyGeneratorFactory
{
    ...
    private static IKeyGenerator GetKeyGenerator(VersionConstants constants) =>
        constants.GameVersion switch
        {
            ...
            "2026.01.30.0000.0000" => new KeyGenerator74(),
            "2026.02.20.0000.0000" => new KeyGenerator74(),
            "2026.03.07.0000.0000" => new KeyGenerator74(),
            "2026.03.17.0000.0000" => new KeyGenerator74(),
            "2026.04.21.0000.0000" => new KeyGenerator74(),
            "2026.05.01.0000.0000" => new KeyGenerator74(),
            "2026.05.25.0000.0000" => new KeyGenerator74(),
            "2026.06.10.0000.0000" => new KeyGenerator74(),
            "2026.06.18.0000.0000" => new KeyGenerator74(),
            "2026.07.16.0001.0000" => new KeyGenerator74(),
            "2026.08.05.0000.0000" => new KeyGenerator74(),
