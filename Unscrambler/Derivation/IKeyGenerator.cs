...
public interface IKeyGenerator {
    ...
    /// </summary>
    /// <param name="initZonePacket">
    ///     The initzone packet, starting from after the packet header, sometimes called
    ///     the segment header.
    /// </param>
    /// <exception cref="NotImplementedException">
    ///     If this IKeyGenerator was provided for
    ///     version 7.4 / 2025.12.09.0000.0000 or later.
    /// </exception>
    ...
    /// </summary>
    /// <param name="unknownPacket">
    ///     The unknown packet, starting from after the packet header, sometimes called
    ///     the segment header.
    /// </param>
    ...
    /// <exception cref="NotImplementedException">
    ///     If this IKeyGenerator was requested for version
    ///     7.25 hotfix 3 / 2025.06.28.0000.0000 or earlier.
    /// </exception>
