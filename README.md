...
参考: https://github.com/Yarukon/FFXIVNetworkOpcodes/blob/master/output

{ "UpdateGearset" },//ModelEquip

{ "UnknownEffect01" },//EventAction8->EventAction16

{ "UnknownEffect16" },//EventAction16->EventAction32

{ "ActionEffect02" },//EventFinish64->EventFinish128

{ "ActionEffect04" }//EventFinish128->EventFinish255
...
include the seed values required to generate keys. Another packet was able to initialize the obfuscation, but I had
never
